...
describe("multisig test", () => {
    ...
    it("should create a init msig actor constructor params", async () => {
        const params = {
            ...
            constructor_params: Buffer.from(
                wasmSigningTools.serializeParams({
                    Signers: signers,
    ...
    it("should create a init msig actor message", async () => {
        ...
        const result = await msig.createMultisigMsg(
            from,
            signers,
            new BigNumber(100),
            2,
    ...
    it("should create a approve multisig message", async () => {
        const wasmResult = wasmSigningTools.approveMultisig(
            multisigAddress,
            1234,
            signers[0],
            signers[1],
        ...
        const result = await msig.approveMultisigMsg(
            multisigAddress,
            1234,
            signers[0],
            from,
    ...
    it("should create a cancel multisig message", async () => {
        const wasmResult = wasmSigningTools.cancelMultisig(
            multisigAddress,
            1234,
            signers[0],
            signers[1],
        ...
        const result = await msig.cancelMultisigMsg(
            multisigAddress,
            1234,
            signers[0],
            from,
